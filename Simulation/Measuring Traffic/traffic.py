f_in = open('Simulation/Measuring Traffic/traffic.in','r')
f_out = open('Simulation/Measuring Traffic/traffic.out','w')
...
for status, lower_i, upper_i in sensors:
    upper_i = int(upper_i); lower_i = int(lower_i)
    if status == "none":
